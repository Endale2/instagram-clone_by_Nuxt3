<template>
  ...
  >
    <!-- Instagram Logo -->
    <div v-if="!isSearchActive" class="text-white text-2xl font-bold mb-4 lg:block hidden">
      Instagram Clone
    </div>
    ...
    <nav class="flex flex-col space-y-6 w-full">
      <a
        href="#"
        class="flex items-center justify-center lg:justify-start space-x-4 text-white font-medium hover:text-gray-400"
      >
        <Icon icon="mdi:home-outline" class="h-6 w-6" />
        <span v-if="!isSearchActive" class="hidden lg:block">Home</span>
      </a>
      <a
        @click="toggleSearch"
      ...
      >
        ...
        <span v-if="!isSearchActive" class="hidden lg:block">Search</span>
      </a>
      <a
        href="#"
      ...
      >
        ...
        <span v-if="!isSearchActive" class="hidden lg:block">Explore</span>
      </a>
      <a
        href="#"
        class="flex items-center justify-center lg:justify-start space-x-4 hover:text-gray-400"
      >
        ...
        <span v-if="!isSearchActive" class="hidden lg:block">Reels</span>
      </a>
      <a
        href="#"
        class="flex items-center justify-center lg:justify-start space-x-4 hover:text-gray-400"
      >
        ...
        <span v-if="!isSearchActive" class="hidden lg:block">Messages</span>
      </a>
      <a
        href="#"
        class="flex items-center justify-center lg:justify-start space-x-4 hover:text-gray-400"
      >
        ...
        <span v-if="!isSearchActive" class="hidden lg:block">Notifications</span>
      </a>
      <a
        href="#"
        class="flex items-center justify-center lg:justify-start space-x-4 hover:text-gray-400"
      >
        ...
        <span v-if="!isSearchActive" class="hidden lg:block">Create</span>
      </a>
      <a
        href="#"
        class="flex items-center justify-center lg:justify-start space-x-4 hover:text-gray-400"
      >
        ...
        <span v-if="!isSearchActive" class="hidden lg:block">Profile</span>
      </a>
      <a
        href="#"
        class="flex items-center justify-center lg:justify-start space-x-4 hover:text-gray-400"
      >
        ...
        <span v-if="!isSearchActive" class="hidden lg:block">More</span>
      </a>
    </nav>

    <!-- Search Bar -->
    <div v-if="isSearchActive" class="search-bar w-full mt-6 flex justify-center lg:justify-start">
      <input
        type="text"
